  ...
  return (
    <>
      <View style={styles.mainContainer}>
        ...
        <View style={{
          marginStart: '20%', flexDirection: 'row', marginTop: '2%', marginEnd: '20%', paddingBottom: 10, borderWidth: 1, marginBottom: 8, borderRadius: 10, backgroundColor: 'white'
        }}>
          <Feather name='check-square' size={28} style={{ marginTop: 12, color: '#4ACF4E', marginStart: '15%' }} />
          <Button color='green' style={{ fontSize: 20, marginStart: '4%', marginTop: 8 }}>{t('Completed')}</Button>
        </View>
      </View>
      <View style={styles.mainContainer}>
        <View style={styles.contentBox}>
        ...
        <View style={{ marginStart: '20%', flexDirection: 'row', marginTop: '2%', marginEnd: '20%', paddingBottom: 10, borderWidth: 1, marginBottom: 8, borderRadius: 10, backgroundColor: 'white' }} >
          ...
          <Button color='red' style={{ fontSize: 20, marginStart: '4%', marginTop: 8 }}>{t('Incomplete')}</Button>
        </View>
      </View>
    </>
  )
  ...
  return (
    <ScrollView>
      <View style={{ backgroundColor: '#fff', flex: 1 }}>
        ...
        <CompletedCard bookingId='UWHYD00001043' Name={t('Site Name')} Sqft="45,982" Address="D-216, DSR For" Amount='24,500' />
        <CompletedCard bookingId='UWHYD00001043' Name={t('Site Name')} Sqft="45,982" Address="D-216, DSR For" Amount='24,500' />
        <CompletedCard bookingId='UWHYD00001043' Name={t('Site Name')} Sqft="45,982" Address="D-216, DSR For" Amount='24,500' />
        <View style={{ marginTop: '5%', marginHorizontal: '10%' }}>
