...
const UpcomingTaskSupervisorScreen = ({navigation}) => {
  ...
  const onSubmit = () => {
    let errors = [];
    if (workDone === '') {
      errors.push('workDone');
    }
    if (siteCleaned === false) {
      errors.push('siteCleaned');
    }
    if (errors.length) {
      setErrors(errors);
    }
  ...
  const fetchAreaId = async () => {
    let result = await fetch(
      'https://uniworksvendorapis.herokuapp.com/vendor/projectArea/3',
    )
      .then((response) => {
  ...
  const handleShowMilestone1 = () => {
    setShowMilestone1(!showMilestone1);
  };
  const handleShowMilestone2 = () => {
    setShowMilestone2(!showMilestone2);
  };
  const handleShowMilestone3 = () => {
  ...
  const renderPrerequisite = ({item}) => {
    return (
      <View style={{marginStart: '5%', marginBottom: 15}}>
        <Text style={{color: '#353535', fontSize: 18, opacity: 0.5}}>
          - {t(item)}
        </Text>
      </View>
    );
    ...
    <>
      <ScrollView style={{backgroundColor: '#eee'}}>
        {isLoading ? (
          <Spinner
            visible={isLoading}
            textContent={t('Fetching Data')}
            textStyle={{color: '#000'}}
          />
        ) : (
          <View style={styles.mainContainer}>
            <Text style={{color: '#909090', fontSize: 30, alignSelf: 'center'}}>
              {t('Wooden Partition')}
            </Text>
            ...
            <View
              ...
              <View style={{alignItems: 'center', marginBottom: '5%'}}>
                <Text style={{paddingTop: 15, color: '#fff', fontSize: 20}}>
                  {t('Description')}
                </Text>
                <View
                  style={{marginTop: 10, alignItems: 'center', width: '75%'}}>
                  <Text
                    style={{color: '#fff', fontSize: 16, textAlign: 'left'}}>
                    1.{' '}
                  ...
                  <>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text
                        ...
                        {t('Solid wood for frame/ support')}
                      </Text>
                      <View
                        style={{
                          flex: 1,
                        ...
                        {checked1 ? (
                          <View
                            style={{alignSelf: 'center', margin: 17}}></View>
                        ) : (
            ...
            <View
              ...
              <Text
                style={{color: '#353535', fontWeight: 'bold', fontSize: 18}}>
                {t("Today's Target")}
              </Text>
              <Text style={{marginStart: '5%', color: '#353535', fontSize: 18}}>
                45,698 {t('Sqft')}
              </Text>
            </View>
            <View
              ...
              <View style={{marginRight: '18%'}}>
                <CheckBox
                  ...
                  containerStyle={{
                    ...
                    borderWidth: 1,
                    borderColor: errors.includes('siteCleaned')
                      ? 'red'
                      : '#eee',
                  }}
            ...
            <View style={{alignItems: 'center', marginTop: 50}}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  onSubmit();
                  navigation.replace('SuperVisorBottom');
                }}>
