    ...
    <ScrollView >
      <View style={styles.mainContainer} >
        ...
        <View style={{ flex: 1, marginTop: '10%' }} >
          ...
          <View style={{ flex: 1 }} >
            <Text style={styles.TypeStyle, { top: 25, fontSize: 20, marginLeft: '15%' }} >Tools</Text>
            <Text style={{ marginLeft: '20%', marginTop: '10%' }} >Tool 0</Text>
            <Text style={{ marginLeft: '20%', marginTop: '5%' }} >Tool 1 </Text>
            <Text style={{ marginLeft: '20%', marginTop: '5%' }} >Tool 2</Text>
            <Text style={{ marginLeft: '20%', marginTop: '5%' }} >Tool 3</Text>
            <Text style={{ marginLeft: '20%', marginTop: '5%' }} >Tool 4</Text>
            <Text style={{ marginLeft: '20%', marginTop: '6%' }} >Tool 5</Text>
          </View>
          ...
          <View style={{ flexDirection: 'row', marginHorizontal: '10%', marginTop: 30 }} >
            <TouchableOpacity onPress={() => navigation.navigate('After Reaching Site')} >
              <Text style={{ fontSize: 24, color: '#93D152' }}>Update</Text>
            </TouchableOpacity >
            <View style={styles.SiteEngineerFiller}></View>
