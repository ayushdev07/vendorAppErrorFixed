...
//   const onRegionChange = (region) => { this.setState({ region }); }
...
//                   <Text style={{ fontSize: 24, color: '#93D152', fontWeight: 'bold' }}>{t('Confirm')}</Text>
//                 </TouchableOpacity >
//                 <View style={{ flex: 1, flexDirection: 'row' }} />
//                 <TouchableOpacity onPress={() => navigation.goBack()} >
//                   <Text style={{ fontSize: 24, color: '#FF0000', fontWeight: 'bold' }}>{t('Cancel')}</Text>
//                 </TouchableOpacity >
//               </View>
//             </View>
//           </View>
...
import React, { useState, useEffect } from 'react'
import { Text, View, StyleSheet, Dimensions, Image, Alert, PermissionsAndroid } from 'react-native'
import Feather from 'react-native-vector-icons/FontAwesome'
import { ScrollView, TouchableOpacity, FlatList } from 'react-native-gesture-handler'
import MapView, { Marker } from 'react-native-maps'
    ...
    <ScrollView>
      {
        isLoading ? <Spinner visible={isLoading} textContent={'Loading'} textStyle={{ color: '#FFF' }} /> :
          <View style={styles.mainContainer}>
            ...
            <View style={{ alignSelf: 'center', top: 30, marginBottom: 30, width: '80%', height: 200, borderRadius: 10, overflow: 'hidden' }}>
              <MapView
            ...
            <View style={{ flex: 1, marginTop: '10%' }}>
              <View style={styles.SiteEngineerRow}>
                <Text style={{ color: '#353535', fontSize: 18, fontWeight: 'bold', maxWidth: '80%' }}>
                  {project.address} {project.zip.toString()}
                </Text>
                <View style={styles.SiteEngineerFiller}></View>
                <Feather name="share-alt" color="black" size={25} style={{ top: 5 }} />
              </View>
