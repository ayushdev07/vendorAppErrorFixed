...
class TabScren extends Component {
      ...
      <Container>
        <Tabs tabBarUnderlineStyle={{ backgroundColor: 'black' }}>
          <Tab
            ...
            heading={t('Opportunity')}>
            {/* <Entypo style={{ fontSize: 24, top: 4 }} name='new-message' color='#E32626' /> */}
            <OpportunityTab navigation={this.props.navigation} />
          </Tab>
          <Tab
            tabStyle={{ backgroundColor: 'white' }}
            activeTabStyle={{ backgroundColor: '#fff' }}
            ...
            activeTextStyle={{ color: 'black', fontWeight: 'bold' }}
            heading={t('Ongoing')}>
            <OngoingTab navigation={this.props.navigation} />
          </Tab>
          <Tab
            tabStyle={{ backgroundColor: 'white' }}
            activeTabStyle={{ backgroundColor: '#fff' }}
            ...
            activeTextStyle={{ color: 'black', fontWeight: 'bold' }}
            heading={t('Upcoming')}>
            <UpcomingTab navigation={this.props.navigation} />
          </Tab>
        </Tabs>
      </Container>
    );
...
export default withTranslation()(TabScren);
